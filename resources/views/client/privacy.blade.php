   ...
   <div class="container">
      <div class="row">
         ...
         <div class="help_headings collapse" id="help_menu_mobile">
            ...
            <h2><a href="{{ url('/privacy') }}" class="active">Privacy Policy</a></h2>
      ...
      <div class="col-12 col-sm-12 col-md-8 col-lg-9">
                   <div class="help_desc">
                     <h1 class="help_title">@php echo $privacyTerms->help_title; @endphp</h1>
                    
                     <p class="privacy_desc margin_top20">@php
                            echo $privacyTerms->help_descrip;
                        @endphp</p>
                  </div>
               </div>
               </div>

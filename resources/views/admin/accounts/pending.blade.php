...
<div class="row page-titles mx-0">
    <div class="col-sm-6 p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0)">{{trans('app.Pending Accounts')}}</a></li>
        </ol>
    </div>
...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h3 class="content-heading mt-2">{{trans('app.Pending Accounts')}}</h3>
        </div>
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="col-lg-4">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" placeholder="{{trans('app.Search Accounts')}}" id="search" name="search" value="<?php if(isset($search)){ echo $search; } ?>" maxlength="30">

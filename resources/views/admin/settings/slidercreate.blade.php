        ...
        <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ URL::to('admin/slidercreate') }}">{{trans('app.New Prime Benefit slider')}}</a></li>
                        </ol>
                    </div>
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">&nbsp;</div>
                            ...
                            <div class="row">
                            <div class="col-12">
                            <h3 class="content-heading mt-2">{{trans('app.New Prime Benefit slider')}}</h3>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="{{action('Admin\SettingsController@sliderstore')}}" method="post"  enctype="multipart/form-data" onSubmit="return validatesliderdata()" >
                                        @csrf
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input type="text" class="form-control" id="val-title" name="val-title" placeholder="{{trans('app.Give a slider title')}}" value="{{old('val-title')}}" maxlength="30">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <textarea name="val-descrip" id="val-descrip" maxlength="250" class="note form-control">{{old('val-descrip')}}</textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-lg-3"></div>
